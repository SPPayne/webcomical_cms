...
class Auth extends CI_Controller {
	...
	function index()
	{
		...
		else
		{
			...
			/* Original ion_auth code (feel free to uncomment...)
	...
	function change_password()
	{
		...
		/* Original ion_auth code, feel free to uncomment and use
	...
	function forgot_password()
	{
		...
		else
		{
			...
			if(empty($identity)){
				$identity = $this->ion_auth->where($identity_column_alt, $this->input->post('identity'))->users()->row();
			}
	...
	/* Part of ion_auth I wasn't planning to use, please feel free to add back in...
		// activate the user
	...
	*/
	...
	function _render_page($view, $data=null, $returnhtml=false)//I think this makes more sense
	{
		...
		//Replaced with custom loader...
		//$view_html = $this->load->view($view, $this->viewdata, $returnhtml);
		$view_html = $this->load->auth_view($view, $this->viewdata, $returnhtml);
