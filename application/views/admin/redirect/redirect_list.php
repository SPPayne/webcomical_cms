...
<?php if(!$redirects){ ?>
	<p>No redirects have been generated yet. However, you can <a href="/admin/create_redirect/">click here to manually add a redirect!</a></p>
<?php } else { ?>
	<p>You can also <a href="/admin/create_redirect/">manually add redirects</a> to your webcomic too.</p>
				...
				<?php foreach($redirects as $redirect){ ?>
					<tr>
						...
						<td class="text-center">
							<a title="Delete redirect" class="delete-button" href="/admin/delete_redirect/<?php echo $redirect->id; ?>"><span class="glyphicon glyphicon-trash"></span></a>
						</td>
					</tr>
				<?php } ?>
			<?php } ?>
