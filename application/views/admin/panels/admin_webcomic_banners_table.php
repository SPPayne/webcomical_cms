			...
			<?php foreach($banners as $banner){ ?>
				<tr>
					<td class="vertical-align">
						<a href="/assets/banners/<?php echo $banner->filename; ?>" target="_blank">
							<?php echo $banner->filename; ?> <span class="glyphicon glyphicon-new-window"></span>
						</a>
					</td>
					<td class="text-center vertical-align">
						<img class="img-responsive" height="100" src="/assets/banners/<?php echo $banner->filename; ?>" />
					</td>
					<td class="text-center vertical-align">
					...
					<td class="text-center vertical-align">
						<a title="Delete banner" class="delete-button" href="/admin/delete_banner/<?php echo $banner->id; ?>"><span class="glyphicon glyphicon-trash"></span></a>
					</td>
				</tr>
			<?php } ?>
		</table>
