<?php if(isset($nav)){ ?>
	<?php if($nav['chapter_jump']['end'] && !empty($nav['chapter_jump']['end'])){ ?>
		<a title="Last <?php echo $site['site_page_term']; ?> in <?php echo $site['site_chapter_term']; ?>" href="/page/<?php echo $nav['chapter_jump']['end']->slug; ?><?php if($nav['preview']){ ?>/preview<?php } ?>">
			<img 
