<?php if(isset($nav)){ ?>
	<?php if($nav['prev_page'] && !empty($nav['prev_page'])){ //Previous page ?>
		<a title="Previous <?php echo $site['site_page_term']; ?>" class="nav-link prev_page" href="<?php echo base_url(); ?>page/<?php echo $nav['prev_page']->slug; ?><?php if($nav['preview']){ ?>/preview<?php } ?>">
			<img 
